...
class MainViewModel(app:Application):AndroidViewModel(app){
    ...
    suspend fun findPressure(id:String)=c.pressure.find(id)
    ...
    fun savePressure(id:String?,sys:Int?,dia:Int?,pulse:Int?,source:PressureSource,checkinId:String?,onDone:()->Unit)=viewModelScope.launch{runCatching{c.pressure.save(id,sys,dia,pulse,Instant.now(),source,checkinId)}.onSuccess{onDone()}.onFailure{_message.value=it.message}}
